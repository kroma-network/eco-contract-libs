...
{
    function initEcoERC20(address initialOwner, string memory _name, string memory _symbol, uint8 _decimals)
        public
        virtual
        initializer
    {
    ...
    function burnFrom(address account, uint256 amount)
        public
        virtual
        override(EcoERC20MintableUpgradeable, IERC20Burnable)
    {
