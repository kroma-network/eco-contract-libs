...
import { IERC721Metadata, IERC721SequencialMintUpbradeable, IERC721Queryable, IERC721Burnable } from "../ERC721/IERC721.sol";
...
import { IEcoERC721URIStorage, EcoERC721URIStorageUpgradeable, EcoERC721IdenticalURIUpgradeable } from "../ERC721/EcoERC721URIStorageUpgradeable.sol";
...
contract NFT_SeqMintableIdenticalURI is NFT_SeqMintable, EcoERC721IdenticalURIUpgradeable {
    ...
    function _update(
        ...
        uint256 tokenId,
        address auth
    ) internal virtual override(ERC721Upgradeable, EcoERC721Base) returns (address) {
    ...
    ) public virtual override(EcoERC721IdenticalURIUpgradeable, EcoERC721URIStorageUpgradeable, IEcoERC721URIStorage) {
