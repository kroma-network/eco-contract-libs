...
contract NFT_Typed is INFT_Typed, NFT_SeqMintable, ERC721TypedUpgradeable {
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721SequencialMintUpbradeable, IERC165)
        returns (bool)
    {
    ...
    function tokenURI(uint256 tokenId)
        ...
        view
        virtual
        override(IERC721Metadata, EcoERC721Base, ERC721TypedUpgradeable)
        returns (string memory)
    {
        return super.tokenURI(tokenId);
    }

    function _nextMint(address to)
        internal
        virtual
        override(ERC721SequencialMintUpbradeable, ERC721TypedUpgradeable)
        returns (uint256)
    {
