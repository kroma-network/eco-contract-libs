...
contract SBT is NFT_SeqMintable, ERC721SoulBoundUpgradeable {
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721SequencialMintUpbradeable, ERC721Upgradeable, IERC165)
        returns (bool)
    {
    ...
    function _update(address to, uint256 tokenId, address auth)
        internal
        virtual
        override(ERC721SoulBoundUpgradeable, EcoERC721Base)
        returns (address)
    {
    ...
    function tokenURI(uint256 tokenId)
        ...
        view
        virtual
        override(ERC721Upgradeable, EcoERC721Base, IERC721Metadata)
