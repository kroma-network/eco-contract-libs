  ...
  describe("Keccak RNG", function () {
    it("Simple Test", async function () {
      ...
      expect(await prng.genKeccak(hashedZeroHash, 32)).deep.eq([
        3166n, 3065n, 318n, 8661n, 4979n,
        26n, 25n, 9635n, 6855n, 7533n,
        6124n, 3715n, 5089n, 7591n, 5788n,
        3822n, 2087n, 3522n, 7574n, 6268n,
        8996n, 6736n, 4530n, 7977n, 5826n,
        2763n, 1806n, 6020n, 504n, 479n,
        1164n, 1375n
      ]);
    });
